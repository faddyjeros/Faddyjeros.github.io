  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-zinc-800 rounded-xl p-4">
        ...
        <p className="text-xs text-zinc-500 mb-4">Monthly snapshots</p>
        ...
        <div className="bg-zinc-800 rounded-xl p-4">
          ...
          <div className="space-y-1 mb-4">
            ...
            {portfolio?.dynamic.map((h) => (
              <div key={h.ticker || h.name} className="flex items-center justify-between py-1.5 border-b border-zinc-700">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs text-zinc-500">{h.volume} x {fmt(h.price)}</span>
                </div>
          ...
          <div className="flex justify-between pt-3 mt-2 border-t border-zinc-700">
            <span className="text-sm text-zinc-400">Total (excl. SCI)</span>
